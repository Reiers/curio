...
func NewInitProvingPeriodTask(db harmonyquery.DBInterface, ethClient ethchain.EthClient, fil NextProvingPeriodTaskChainApi, w *Watcher, sender *message.SenderETH, network contract.Network) *InitProvingPeriodTask {
...
func (ipp *InitProvingPeriodTask) Do(ctx context.Context, taskID harmonytask.TaskID, stillOwned func() bool) (done bool, err error) {
	...
	if sendErr != nil {
		...
		comm, err := ipp.db.BeginTransactionI(ctx, func(tx harmonyquery.TxInterface) (commit bool, err error) {
